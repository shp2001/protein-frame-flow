...
## Inference 방법
### Data Processing 
1. /home/{user_name}/data/{target_name}/pdb을 만들고 분석하고자 하는 protein의 PDB 파일을 저장. 
...
2. /home/{user_name}/protein-frame-flow/notebook/process_data.ipynb 주피터 노트북에서 INPUT_PDB_DIR와 CDR_SEQS를 지정하고 '모두 실행' 클릭
    - INPUT_PDB_DIR: 사용자가 PDB 파일을 저장한 디렉토리 
    - CDR_SEQS: 사용자가 지정한 CDR 영역의 서열

### Utilize DMS Data (dms point mutation을 예측하고 싶지 않다면 이 단계는 스킵)
1. /home/{user_name}/data/{target_name}/dms에 Proteina에서 제공한 dms excel 파일 저장
2. /home/{user_name}/protein-frame-flow/notebook/utilize_dms.ipynb 주피터 노트북에서 INPUT_META_DIR, XLSX_FILES, REL_AFFINITY_THRESHOLD을 '모두 실행' 클릭 
    - INPUT_META_DIR: /home/{user_name}/data/{target_name}/meta
