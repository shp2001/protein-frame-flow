...
class prmsd_InvariantPointAttention(nn.Module):
    def __init__(
        self,
        *,
        dim,
    ...
    def forward(
        ...
        *,
        ...
        point_weights = nn.functional.softplus(self.point_weights)
...
class IPABlock(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.attn = prmsd_InvariantPointAttention(dim = dim, **kwargs)
