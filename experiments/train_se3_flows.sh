#!/bin/bash
#SBATCH -J CDRFlow_v2.3.2.1_stage_2_aa_clash_confidence_3
#SBATCH -p gpu
...
torchrun --standalone --nnodes=1 --nproc_per_node=2 /home/psh/protein-frame-flow/experiments/train_se3_flows.py \
    > /home/psh/protein-frame-flow/experiments/logs/CDRFlow_v2.3.2.1_stage_2_aa_clash_confidence_3.log 