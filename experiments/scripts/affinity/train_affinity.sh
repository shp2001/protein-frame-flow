...
#SBATCH -e /home/psh/protein-frame-flow/experiments/logs/train_fm_w_coords.err
...
torchrun --standalone --nnodes=1 --nproc_per_node=4 /home/psh/protein-frame-flow/experiments/scripts/affinity/train_affinity.py \
    > /home/psh/protein-frame-flow/experiments/logs/v2.3.2.2_affinity_w_coords.log 