...
parser.add_argument(
    ...
    type=str,
    default='/home/psh/data/affinity/pdb_ids.txt')
parser.add_argument(
    '--num_processes',
...
parser.add_argument(
    ...
    type=str,
    default='/home/psh/data/affinity/meta')
parser.add_argument(
    '--debug',
...
def process_cif_file(file_path: str, write_dir: str, cfg: str):
    ...
    try:
        ...
        if len(models) == 1:
            ...
            return None 
            # raise ValueError(f"{pdb_name}: The number of models should be 1. But it is {len(models)}")
